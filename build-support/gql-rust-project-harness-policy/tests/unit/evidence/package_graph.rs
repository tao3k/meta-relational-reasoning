...
use gql_rust_project_harness_policy::{
    GqlRustProjectHarnessEvidenceGraphInput, GqlRustProjectHarnessPackageEvidenceGraphRequest,
...
fn package_receipt_summarizes_client_db_evidence_graph() {
    ...
    let receipt =
        build_package_evidence_graph_receipt(GqlRustProjectHarnessPackageEvidenceGraphRequest {
