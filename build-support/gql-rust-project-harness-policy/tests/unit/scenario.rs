use gql_rust_project_harness_policy::{
    gql_rust_project_harness_scenario, gql_rust_project_harness_scenario_package,
};

#[test]
fn scenario_macro_packages_custom_scenario_data() {
    let scenario = gql_rust_project_harness_scenario! {
...
fn scenario_package_macro_groups_custom_scenarios() {
    ...
    let package = gql_rust_project_harness_scenario_package! {
        package: "gql",
        scenarios: [scenario],
    };
