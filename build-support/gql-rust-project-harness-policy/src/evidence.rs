...
pub struct GqlRustProjectHarnessEvidenceGraphInput {
...
pub struct GqlRustProjectHarnessEvidenceGraphSummary {
...
pub fn summarize_client_db_evidence_graph(
    graph: &GqlRustProjectHarnessEvidenceGraphInput,
) -> GqlRustProjectHarnessEvidenceGraphSummary {
    GqlRustProjectHarnessEvidenceGraphSummary {
