...
use crate::{
    MrrRustProjectHarnessScenarioPackage, mrr_rust_project_harness_scenario,
    mrr_rust_project_harness_scenario_package,
};
...
#[must_use]
pub fn gql_search_scenario_package() -> MrrRustProjectHarnessScenarioPackage {
    mrr_rust_project_harness_scenario_package!(
        package: GQL_SEARCH_SCENARIO_PACKAGE_NAME,
        scenarios: [
            mrr_rust_project_harness_scenario!(
