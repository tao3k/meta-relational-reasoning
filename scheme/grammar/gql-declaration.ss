    ...
    ((_ consumer grammar-binding dialect-id dialect-label parser-authority-binding)
     #'(consumer grammar-binding
         ...
         (syntax-kinds
          ...
          (TruthPredicateExpression node (operand truth-value negated))
          (ValueTypePredicateExpression node (operand value-type negated marker))
          (DirectedPredicateExpression node (edge negated))
          (EndpointPredicateExpression node (node edge endpoint negated))
          (ElementIdentityPredicateExpression node (kind element))
          (PropertyExistsPredicateExpression node (element property))
          ...
          (AggregateFunctionExpression node (name quantifier argument star))
        ...
        (LabelSetPhrase node (labels))
         ...
         (keywords
          ...
          (Filter "FILTER") (For "FOR") (With "WITH")
          (Ordinality "ORDINALITY")
          (Return "RETURN") (Finish "FINISH")
          (Or "OR") (Xor "XOR") (And "AND") (Not "NOT")
          (Call "CALL")
          (Create "CREATE") (Drop "DROP") (Insert "INSERT") (Delete "DELETE")
          (Set "SET") (Remove "REMOVE") (True "TRUE") (False "FALSE")
          (UnknownTruth "UNKNOWN")
          ...
          (Sum "SUM") (CollectList "COLLECT_LIST")
          (StddevSamp "STDDEV_SAMP") (StddevPop "STDDEV_POP")
          (PercentileCont "PERCENTILE_CONT")
          (PercentileDisc "PERCENTILE_DISC")
          (Distinct "DISTINCT") (All "ALL")
          (AllDifferent "ALL_DIFFERENT") (Same "SAME")
         ...
         (parameter-references
          ...
          (substituted double-dollar separated-identifier catalog-reference))
         (predicate-tests
          ...
          (value-type optional-not declared-value-type value-primary)
         ...
         (aggregate-functions
          ...
          (standard-deviation-sample StddevSamp general optional 1)
          (standard-deviation-population StddevPop general optional 1)
          (percentile-continuous PercentileCont binary dependent 2)
         ...
         (parser-entrypoints
          ...
          (Filter FilterStatement none) (For ForStatement none)
          (Union UnionClause none) (Limit LimitClause none)
          (Order OrderByClause none) (Offset OffsetClause none) (Skip OffsetClause none)
         ...
         (recoveries
          ...
          (graph-match-mode
           "GQL-PARSE-GRAPH-MATCH-MODE-SYNTAX" preserve-source)
          (path-search-prefix
           "GQL-PARSE-PATH-SEARCH-PREFIX-SYNTAX" preserve-source)
          (keep-clause
           "GQL-PARSE-KEEP-CLAUSE-SYNTAX" preserve-source)
          (order-by-clause
           "GQL-PARSE-ORDER-BY-SYNTAX" preserve-source)
          (limit-clause
           "GQL-PARSE-LIMIT-SYNTAX" preserve-source)
          (offset-clause
           "GQL-PARSE-OFFSET-SYNTAX" preserve-source)
          (path-quantifier
          ...
          (predicate-test
           "GQL-PARSE-PREDICATE-TEST-SYNTAX" preserve-source)
          (null-predicate-operand
           "GQL-PARSE-NULL-PREDICATE-OPERAND" preserve-source)
